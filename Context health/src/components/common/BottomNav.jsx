...
export default function BottomNav({ activeId = 'home', onChange }) {
  const tabs = [
    ...
    { id: 'coach', label: 'AI 코치', Icon: IcGenerate },
    { id: 'my',    label: '마이',    Icon: IcUser },
  ];

  return (
    <nav className="absolute bottom-0 w-full bg-white border-t border-ui-3 rounded-t-[16px] h-[68px] flex justify-around items-center z-20 shadow-[0_-6px_16px_rgba(3,7,19,0.10)]">
