    ...
    <div className="flex bg-white flex-none">
      {tabs.map((tab) => (
        <button 
          ...
          className={`flex-1 py-2 text-center text-body-m transition-all duration-150 border-b-2 bg-none border-x-none border-t-none outline-none select-none active:opacity-60 ${
            activeId === tab.id 
