...
> 🔄 **1기 참가자세요?** 1기 때 셋업한 시스템 환경(GitHub PAT, Vercel 프로젝트 등)이 2기와 충돌할 수 있어요.
>
> 1기 개인 레포의 **작업물은 그대로 두세요** (이관 불필요). 2기 작업은 이 BF.D 레포에 새로 올리시면 됩니다.
> **충돌나는 시스템 환경만 정리**하면 OK!
>
> 👉 정리 체크리스트: [**노션 가이드의 "🔄 1기 → 2기 전환 안내"** 섹션](https://zonemy.notion.site/36254dbdae4b803188d2dc1c2fb23394?pvs=143)
